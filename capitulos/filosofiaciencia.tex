...
Algunos filósofos modernos, como Peter Strawson, sostienen que esto de probar el
...
La idea de una \terminology[tesis del conflicto]{tesis del conflicto} entre ciencia y religión es una narrativa popularizada en el siglo XIX \cite{Draper1874,White1896}.
Sin embargo, historiadores como John Hedley Brooke proponen una \terminology[tesis de la complejidad]{tesis de la complejidad}, con interacciones diversas que incluyen apoyo mutuo, diálogo o indiferencia, además de conflicto \cite{Brooke1991}.
...
Anteriormente, lo que hoy conocemos como ciencia era a menudo denominado \terminology[filosofía natural]{filosofía natural}, y frecuentemente se entrelazaba con indagaciones teológicas.
Incluso, la noción de un conflicto inherente pudo haber surgido, en parte, de los procesos de \terminology[profesionalización de la ciencia]{profesionalización de la ciencia} y de los debates sobre la \terminology{secularización}.

El caso de Galileo Galilei es un ejemplo clásico.
Su condena no fue solo un choque entre el \terminology{heliocentrismo} y la doctrina.
Factores como la \terminology{Contrarreforma}, luchas por la autoridad interpretativa y políticas internas del Vaticano fueron cruciales.
De forma similar, el debate sobre la \terminology[teoría de la evolución]{teoría de la evolución} trascendió la biología.
Implicó disputas sobre el \terminology{diseño inteligente} en la naturaleza, el \terminology{creacionismo} y el control de la educación.

Estos debates a menudo se instrumentalizan.
Un ejemplo claro es la campaña de \terminology{desinformación} sobre el cambio climático.
...
Una táctica ha sido la \terminology[instrumentalización de la religión]{instrumentalización de la religión}.
...
Llegan a tildar al \terminology{ambientalismo} de \emph{idolatría} \cite{HultmanKall2019}.
...
El conflicto agudo a menudo no es entre \emph{ciencia} y \emph{religión} en abstracto.
Suele ser entre posturas ideológicas extremas: el cientificismo y el \terminology[fundamentalismo!religioso]{fundamentalismo religioso}.
El \terminology[fundamentalismo!religioso]{fundamentalismo religioso} se aferra a interpretaciones literales y rechaza la crítica.
Ambas posturas, por excluyentes, fomentan la confrontación.

\begin{remember}
    El \terminology[fundamentalismo!religioso]{fundamentalismo religioso} se basa en la adhesión literal a doctrinas, rechazando la crítica.
