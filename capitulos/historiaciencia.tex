...
\begin{enestecapitulo}
	...
	\item[\emoji{atom-symbol}] Por qué la evolución, la relatividad y la cuántica transformaron la ciencia.
	\item[\emoji{robot}] Cómo la computación y la interdisciplinariedad definen la ciencia actual.
\end{enestecapitulo}
...
\begin{remember}
	...
	El \terminology[aristotelismo]{aristotelismo} es la cosmovisión que explica el mundo mediante la razón y la lógica, sin recurrir a la experimentación, y que postula que la naturaleza busca siempre la economía y la perfección.
\end{remember}
...
\begin{figure}[ht]
	...
	\caption{El sistema ptolemaico, en el que la Tierra es el centro del universo. Crédito: Loon, J. van (Johannes), aprox. 1611--1686 / Dominio público.}
...
\section{El puente medieval y la ciencia islámica}
\label{sec:elpuentemedieval}

Es un error muy común pensar que entre la caída del Imperio Romano y la llegada de Copérnico hubo un “hueco oscuro” de ignorancia absoluta.
A este período a menudo se le menosprecia bajo la etiqueta del \terminology{oscurantismo}, pero la realidad histórica es mucho más rica y compleja.
Mientras Europa occidental atravesaba una etapa de fragmentación política y recesión económica, el mundo islámico experimentaba una verdadera edad de oro intelectual.
Desde el siglo \textsc{viii} hasta el \textsc{xiii}, los eruditos árabes y persas no solo tradujeron y preservaron los textos de Aristóteles y Ptolomeo, sino que los corrigieron y ampliaron significativamente \cite{alkhalili2011house}.
Por ejemplo, el polímata \person[Ibn al-Haytham]{Alhacén} (965--1040) revolucionó la óptica al demostrar mediante experimentos que la visión ocurre porque la luz rebota en los objetos y entra en nuestros ojos, refutando la antigua idea griega de que nuestros ojos emitían “rayos visuales”.
El rigor empírico de sus experimentos con lentes y espejos lo convierte, para muchos historiadores, en uno de los primeros pioneros de lo que hoy llamaríamos método científico.
Por su parte, el matemático \person[Al-Juarismi]{Muhammad} (780--850) formalizó las reglas del álgebra y nos legó los números arábigos, herramientas sin las cuales la física moderna sería matemáticamente imposible de calcular.

\begin{remember}
	\label{rem:edad-oro-islamica}
	La \terminology[edad de oro islámica]{edad de oro islámica} fue un período de gran florecimiento cultural donde se preservó el saber clásico y se sentaron las bases prácticas del álgebra, la medicina y la óptica.
\end{remember}

Eventualmente, todo este conocimiento acumulado fue reintroducido en Europa occidental a través de la península ibérica y de los intercambios durante las cruzadas.
A partir del siglo \textsc{xii}, comenzaron a fundarse las primeras universidades europeas, instituciones que transformarían para siempre la manera de enseñar y debatir las ideas \cite{grant1996foundations}.
Filósofos como \person[de Aquino]{Tomás} (1225--1274) se dedicaron a la colosal tarea de reconciliar la lógica del aristotelismo con la teología cristiana, un esfuerzo analítico monumental conocido como la \terminology{escolástica}.
Aunque los académicos medievales seguían atados a la autoridad dogmática de los textos antiguos y de la Iglesia, lograron perfeccionar el arte del debate lógico y la argumentación racional.
De hecho, figuras como \person[Bacon]{Roger} (1219--1292) comenzaron a insistir, aunque tímidamente, en la necesidad de verificar los argumentos filosóficos mediante la observación directa de la naturaleza.

\begin{digress}{El mito de la Tierra plana}
	Existe una creencia sumamente popular que asegura que la gente en la Edad Media pensaba que la Tierra era plana, y que Cristóbal Colón tuvo que navegar para demostrar lo contrario.
	Esto es un mito absurdo inventado y popularizado en el siglo \textsc{xix} \cite{russell1991flatearth}.
	Cualquier persona medianamente educada del medievo europeo o del mundo islámico sabía perfectamente que la Tierra era esférica, un hecho que ya había sido medido por los antiguos griegos.
	El verdadero debate científico de la época de Colón no era la forma del mundo, sino su circunferencia total y si los barcos de madera tendrían suficientes provisiones para cruzar el inmenso océano.
\end{digress}

Así, el terreno intelectual, aunque dominado por la teología, quedó perfectamente preparado, estructurado y fertilizado.
Solo faltaba que, unos siglos más tarde, las chispas de Copérnico y Galileo cayeran sobre la pólvora para encender la verdadera revolución de las ciencias.

\section{La revolución científica}
\label{sec:larevolucioncientifica}

Fue hasta 1543 cuando el canónigo católico \person[Copérnico]{Nicolás} (1473--1543) se atrevió a desafiar el aristotelismo publicando su libro \emph{De revolutionibus orbium coelestium} (Sobre las revoluciones de las esferas celestes), en el que propone que el Sol está fijo en el centro del universo y que los planetas giran alrededor de él, dando lugar así a la \index{teoría!heliocéntrica}\emph{teoría heliocéntrica}.
...
Según la tradición relatada por su discípulo Viviani —aunque los historiadores dudan de su veracidad—, esto lo demostró dejando caer dos bolas de diferente peso desde lo alto de la Torre inclinada de Pisa \cite{Viviani2019}.
...
\person[Descartes]{René} (1596--1650), con su \terminology{mecanicismo}, propuso que el universo es como una maquinaria de reloj en la que todo puede explicarse en términos del movimiento y colisión de partículas.
...
\begin{remember}
	...
	El \emph{mecanicismo} es la cosmovisión según la cual el universo se comporta como una maquinaria determinista, y que puede ser explicada en términos del movimiento y colisión de partículas.
\end{remember}
...
\begin{figure}[ht]
	...
	\caption{Isaac Newton en su laboratorio.
		Su mascota \emph{Diamond} tiró una vela sobre una mesa de papeles, quemando varios años de trabajo en el proceso.
		Crédito: Morel / Dominio público.
	}

\end{figure}

Durante un par de siglos se consideró que la teoría de Newton era esencialmente correcta, y que los científicos sólo necesitaban rellenar meros detalles técnicos.
...
\begin{digress}{El relojero ciego}
	...
	Esta idea, conocida como \terminology{deísmo}, reconciliaba la ciencia con la religión: Dios creó el universo con leyes perfectas, y la tarea del científico es descubrir esas leyes.
...
En 1859, \person[Darwin]{Charles} (1809--1882) publicó su libro \emph{El origen de las especies}, en el que propone la teoría de la evolución mediante la \index{selección natural}selección natural.
...
\begin{remember}
	\label{rem:seleccion natural}
	La \terminology[selección!natural]{selección natural} es el mecanismo propuesto por Darwin para explicar la evolución: los organismos mejor adaptados a su entorno sobreviven y se reproducen con mayor éxito, transmitiendo sus características a las siguientes generaciones.
\end{remember}
...
Por otro lado, apareció el problema de la \emph{radiación del cuerpo negro}, que desafiaba la física clásica al intentar comprender cómo un objeto caliente emite radiación electromagnética.
...
\begin{digress}{Dios no juega a los dados}
	Aunque Einstein sentó las bases de la cuántica con su explicación del efecto fotoeléctrico, nunca aceptó del todo sus implicaciones.
	Su famosa frase “Dios no juega a los dados con el universo” refleja su rechazo al carácter probabilístico de la mecánica cuántica.
	Irónicamente, décadas de experimentos han confirmado una y otra vez que, en el mundo subatómico, la naturaleza sí parece jugar a los dados.
\end{digress}
...
\begin{remember}
	...
	El \terminology[empirismo!lógico]{empirismo lógico} es una corriente filosófica que sostiene que el único conocimiento válido es el que se basa en la experiencia, la observación y la lógica.
	Una afirmación que no tiene contenido empírico o lógico es considerada \terminology{metafísica}, y por lo tanto no tiene sentido.
\end{remember}
...
En el proceso sentó las bases de la \terminology{computación} como disciplina científica.
...
Para 1953, \person[Watson]{James} (1928--) y \person[Crick]{Francis} (1916--2004) descubrieron la estructura del ácido desoxirribonucleico (ADN), la molécula que contiene la información genética de los seres vivos, dando inicio a la \terminology[biología!molecular]{biología molecular} que estudia los procesos biológicos en términos de las moléculas que los componen.
...
En 2003 se completó el \terminology[Proyecto Genoma Humano]{Proyecto Genoma Humano}, que consistió en secuenciar el ADN de un ser humano, y que ha permitido entender mejor las enfermedades genéticas y desarrollar nuevos tratamientos médicos.
...
El siglo \textsc{xx} fue testigo de la creación o formalización de disciplinas como \terminology[economía]{economía}, \terminology[antropología]{antropología}, \terminology[sociología]{sociología}, \terminology[psicología]{psicología}, y \terminology[lingüística]{lingüística}.
...
La tendencia actual es la \terminology{interdisciplinariedad}, es decir, la colaboración entre diferentes disciplinas.
Esto fue facilitado por la computación, que es usada como herramienta en todas partes.
Por ejemplo, la climatología estudia el clima de la Tierra, y para ello \terminology[simulación]{simula} el comportamiento de la atmósfera mediante modelos computacionales.
...
\begin{remember}
	...
	La \emph{interdisciplinariedad} es la colaboración entre diferentes disciplinas para resolver un problema, y es la base de la ciencia moderna.
\end{remember}

En este período también se desarrolló la \terminology{inteligencia artificial}, que estudia la creación de máquinas inteligentes.
...
\begin{remember}
	...
	La ciencia pasó de ser una actividad especulativa en la antigüedad, a una empresa experimental en la revolución científica, a una disciplina colaborativa e interdisciplinaria en la actualidad.
\end{remember}

Dado este breviario histórico estarás tentado a pensar que la ciencia es un proceso lineal de acumulación de conocimiento, pero la realidad es mucho más compleja.
De hecho, el mero hecho de distinguir el conocimiento científico del no científico es un tema de debate filosófico, y lo abordaremos en el siguiente capítulo.