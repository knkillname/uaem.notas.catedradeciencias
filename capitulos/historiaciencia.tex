...
Tal es el caso de \index{Aristóteles} (384--322 a. C.), quien propuso muchas teorías físicas basándose en acertijos conceptuales y razonamientos lógicos, pero sin experimentación ni observación\cite{Shields2023}.
...
Parte central del aristotelismo fue la \index{teoría!geocéntrica}, introducida por \index{Ptolomeo} (90--168 d. C.).
...
\index{Descartes, René} (1596--1650), con su \emph{mecanicismo}, propuso que el universo es como una maquinaria de reloj en la que todo puede explicarse en términos del movimiento y colisión de partículas.
...
Por su parte, \index{Newton, Isaac} (1643--1727) propuso sus tres leyes del movimiento y la ley de la gravitación universal, que explica la atracción entre los cuerpos celestes.
...
En 1859, \index{Darwin, Charles} (1809--1882) publicó su libro \emph{El origen de las especies}, en el que propone la teoría de la evolución mediante la selección natural.
...
A mediados del siglo \textsc{xix} el físico escocés \index{Maxwell, James} (1831--1879) descubrió que la luz es una onda electromagnética que se propaga a la velocidad de la luz, unificando así las teorías de la electricidad y el magnetismo.
...
En 1905, \index{Einstein, Albert} (1879--1955) publicó su \emph{teoría de la relatividad especial}, en la que propuso que el tiempo y el espacio son relativos, y que la velocidad de la luz es la misma para todos los observadores.
...
Este problema fue resuelto por \index{Planck, Max} (1858--1947) en 1900, quien propuso que la energía se emite en paquetes discretos llamados \emph{cuantos}, dando origen a la \index{mecánica cuántica}.
...
En 1936, \index{Turing, Alan} (1912--1954) publicó su artículo \emph{On computable numbers, with an application to the Entscheidungsproblem}, en el que propuso una teoría acerca de las limitaciones de lo que se puede calcular...
En el proceso sentó las bases de la \index{computación} como disciplina científica.
...
Para 1953, \index{Watson, James} (1928--) y \index{Crick, Francis} (1916--2004) descubrieron la estructura del ácido desoxirribonucleico (ADN), la molécula que contiene la información genética de los seres vivos, dando inicio a la \index{biología!molecular} que estudia los procesos biológicos en términos de las moléculas que los componen.
...
En 2003 se completó el \index{Proyecto Genoma Humano}, que consistió en secuenciar el ADN de un ser humano, y que ha permitido entender mejor las enfermedades genéticas y desarrollar nuevos tratamientos médicos.
