...
\begin{remember}
	...
	El \terminology[aristotelismo]{aristotelismo} es la cosmovisión que explica
	el mundo mediante la razón y la lógica, sin recurrir a la experimentación,
	y que postula que la naturaleza busca siempre la economía y la perfección.
\end{remember}
...
A este período a menudo se le menosprecia bajo la etiqueta de las “edades oscuras”, pero la realidad histórica es mucho más rica y compleja.
...
\begin{digress}{El relojero ciego}
	...
	Esta idea, conocida como \emph{deísmo}\index{deísmo}, reconciliaba la ciencia con la religión: Dios creó el universo con leyes perfectas, y la tarea del científico es descubrir esas leyes.
...
\begin{remember}
	...
	La \terminology[selección!natural]{selección natural} es el mecanismo
	propuesto por Darwin para explicar la evolución: los organismos mejor
	adaptados a su entorno sobreviven y se reproducen con mayor éxito,
	transmitiendo sus características a las siguientes generaciones.
\end{remember}
...
\begin{digress}{Dios no juega a los dados}
	Aunque Einstein sentó las bases de la cuántica con su explicación del
	efecto fotoeléctrico, nunca aceptó del todo sus implicaciones.
	Su famosa frase «Dios no juega a los dados con el universo» refleja su
	rechazo al carácter probabilístico de la mecánica cuántica.
	Irónicamente, décadas de experimentos han confirmado una y otra vez que,
	en el mundo subatómico, la naturaleza sí parece jugar a los dados.
\end{digress}
...
Por ejemplo, la climatología estudia el clima de la Tierra, y para ello simula el comportamiento de la atmósfera mediante modelos computacionales\index{simulación}.
...
En este período también se desarrolló la \index{inteligencia artificial}inteligencia artificial, que estudia la creación de máquinas inteligentes.
